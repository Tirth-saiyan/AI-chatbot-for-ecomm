...
```bash
git clone git@github.com:Tirth-saiyan/AI-Chatbot-for-ecomm-Data-pipeline.git
```

### On Windows
Open a terminal and run:
```bash
git clone https://github.com/Tirth-saiyan/AI-Chatbot-for-ecomm-Data-pipeline.git
```
