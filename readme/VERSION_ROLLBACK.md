...
1. **Access Cloud Run Console**:
   ...
   - Navigate to **Cloud Run** and select your service (e.g., `AI-chat-service`).
...
3. **Select a Stable Revision**:
   - Identify the last stable revision (e.g., `AI-chat-service-00012`).
